...
import AddAssetModal from "../../task/task detail/task modals/AddAssetModal";
...
const ProjectAssets = ({ projectId }) => {
  ...
  const {
    ...
    projectId ? `${API_BASE_URL}/api/assets/list/?project=${projectId}` : null,
    "GET",
    null,
    [projectId]
  );
    ...
    <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-4 sm:p-6">
      <div className="flex items-center justify-between mb-3 sm:mb-4">
        ...
        <button
          ...
          disabled={isLoading}
          className="flex items-center text-center gap-2 text-blue-600 hover:text-blue-700 text-xs sm:text-sm font-medium px-2 py-1 rounded-md hover:bg-blue-50 transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
        >
          <FaPlus size={14} />
      ...
      {isLoading ? (
        ...
        <div className="text-center py-6 sm:py-8">
          <FaPaperclip className="w-10 h-10 sm:w-12 sm:h-12 mx-auto text-gray-400" />
